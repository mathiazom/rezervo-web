...
import { AllowedTimeWindow, HourAndMinute, NotificationsConfig, PreferencesPayload } from "@/types/openapi";
                            ...
                            <>
                                <FormGroup sx={{ py: 2 }}>
                                    ...
                                    <FormLabel disabled={reminderHoursBeforeLoading}>
                                        <SwitchWrapper
                                            label={"Påminnelse om time"}
                                            loading={reminderHoursBeforeLoading}
                                        >
                                            <Switch
                                    ...
                                    <Box sx={{ display: "flex", gap: 1, alignItems: "center", pb: 1 }}>
                                        <FormControl>
                                            <TimePicker
                                                disabled={
                                                    reminderWindowLoading ||
                                                    !reminderWindowActive ||
                                                    reminderWindow == null
                                                }
