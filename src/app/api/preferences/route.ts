...
export const GET = withApiAuthRequired(async (req) => {
    ...
    return await doOperation(() => get(`${process.env["CONFIG_HOST"]}/preferences`, accessToken));
});
...
export const PUT = withApiAuthRequired(async (req) => {
    ...
    return await doOperation(() => put(`${process.env["CONFIG_HOST"]}/preferences`, accessToken, data));
});
