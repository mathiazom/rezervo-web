...
import { FscGroupActivitiesResponse, FscWeekSchedule } from "../../types/integration/fsc";
...
export async function fetchWeekSchedule(weekOffset: number): Promise<FscWeekSchedule> {
    ...
    const responseData: FscGroupActivitiesResponse = await groupActivitiesResponse.json();
