              ...
              return (
                <Box key={_class.id} mb={1}>
                  <ClassCard
                    ...
                    onSelectedChanged={(s) =>
                      onSelectedChanged(_class.id.toString(), s)
                    }
            ...
            >
              ...
              >
                <ClassPopularityMeter
                  popularity={lookupActivityPopularity(modalClass).popularity}
                />
              ...
              {modalClass.image && (
                <Box pt={2}>
                  <Image
                    ...
                    height={300}
                    objectFit={"cover"}
                    style={{ borderRadius: "0.25em", padding: 0 }}
                  ></Image>
                </Box>
              )}
              <Typography pt={2}>{modalClass.description}</Typography>
            </Box>
          )}
        </>
      </Modal>
